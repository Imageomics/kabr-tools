...
Download model weights from the [X3D-KABR-Kinetics repo](https://huggingface.co/imageomics/x3d-kabr-kinetics).
...
See the [time budgets notebook](../case_studies/0_time_budget/time_budget.ipynb) for the code to create the visualizations.
